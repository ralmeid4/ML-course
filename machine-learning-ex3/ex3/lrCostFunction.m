...
% regularized cost function code from last week
...
J=(1/(m)*sum(costreg)) + (lambda/(2*m))*sum(theta(2:end,1).^2); % finalizing J with the regularization term

% regularized grad code from last week
